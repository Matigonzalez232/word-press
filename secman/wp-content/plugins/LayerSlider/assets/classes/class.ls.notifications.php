...
class LS_Notifications {
	...
	private static function _gatherDynamicNotifications() {
		...
		self::prependInlineNotification([
			...
			'title' 		=> __('Layerslider Has a New Home', 'LayerSlider'),
			'fixed'			=> true,
			'class' 		=> 'ls-leaving-envato-notice',
			'message' 		=> 'We’re in the process of leaving CodeCanyon / Envato Market and continue developing LayerSlider independently. Don’t worry; you’re still entitled to all the benefits, no matter where you purchased your license. The only thing that has changed is where you can get LayerSlider. <b>To hide this notice, please update to the non-Envato version of the plugin.</b>',
			'buttons' 		=> [[
				'text' 		=> __('How To Update', 'LayerSlider'),
				'href' 		=> 'https://layerslider.com/how-to-update/',
				'target' 	=> '_blank'
			],[
				'text' 		=> __('Learn More', 'LayerSlider'),
				'href' 		=> 'https://layerslider.com/leaving-envato/',
				'target' 	=> '_blank'
			]]
		]);
